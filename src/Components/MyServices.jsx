...
const MyServices = () => {
  ...
  const url = `https://assign11server.vercel.app/api/v1/services/${user?.email}`;
  useEffect(() => {
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`https://assign11server.vercel.app/api/v1/services/${id}`)
          .then((res) => {
                  ...
                  <tr className="text-center">
                    ...
                    <th>
                      <button
                        ...
                        className="btn btn-error block mx-auto btn-xs capitalize"
                      >
                        Delete
                      </button>
                    </th>

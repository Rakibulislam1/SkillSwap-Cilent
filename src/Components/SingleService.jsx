...
const SingleService = () => {
  ...
  const handleBooking = event => {
    ...
    const date = form.providerEmail.value;
    const booking = {
      myOrder: price,
      date,
      serviceName,
      ...
      <Helmet>
        ...
        <dialog id="my_modal_4" className="modal">
          <div className="modal-box w-11/12 max-w-5xl">
            ...
            <form onSubmit={handleBooking} className="grid grid-cols-1 gap-3 lg:grid-cols-2">
              ...
              <div className="form-control">
                ...
                <input
                  type="text"
                  defaultValue={singleService.service_image}
                  disabled
                  placeholder="Image"
                  name="photo"
                  className="input input-bordered"

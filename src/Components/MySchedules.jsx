                ...
                <tr className="text-center">
                  <td>
                    <div className="flex items-center justify-center space-x-3">
                      <div>
                        <div className="font-bold">{schedules.provider_name}</div>
                      </div>
                    </div>
                  </td>
                  <td>
                    <span>
                      {schedules.service_name}
                    </span>
                  </td>
                  <td>{schedules.date}</td>
                  <td>$ {schedules.service_price}</td>
                  <th>
                    <button className="btn btn-warning block mx-auto btn-xs capitalize">Pending</button>
                  </th>
                </tr>
              </tbody>
            </table>

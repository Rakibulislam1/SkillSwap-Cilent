...
const Footers = () => {
  return (
    <Footer>
      <div className="w-full bg-gradient-to-r text-white from-[#6345ED] to-[#DC39FC]">
        <div className="flex md:flex-row items-center flex-col px-2">
          <div className="flex-[1] lg:ml-20">
            <h2 className="text-xl font-bold text-transparent bg-clip-text text-white mt-5 md:mt-0">
              SkillSwap
            </h2>
          </div>
